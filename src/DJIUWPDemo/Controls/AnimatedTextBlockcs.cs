...
namespace DJIDemo.Controls
{
    ...
    public sealed class AnimatedTextBlock : Control
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _rootVisual = ElementCompositionPreview.GetElementVisual(_root);

            _compositor = _rootVisual.Compositor;

            _oldTextBlock = GetTemplateChild<TextBlock>(OldTextblockName);
            _oldTextBlockVisual = ElementCompositionPreview.GetElementVisual(_oldTextBlock);

            _newTextBlock = GetTemplateChild<TextBlock>(NewTextblockName);
            _newTextBlockVisual = ElementCompositionPreview.GetElementVisual(_newTextBlock);
